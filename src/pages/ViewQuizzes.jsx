  ...
  return (
    <div>
     <div class="d-inline-flex p-2 bd-highlight">
      ...
      <div className="text-one coursetitle"> View Quizzes </div>
                  ...
                  <div className="col">
                    <div className="card h-70">
                      ...
                      <div className="card-body">
                        ...
                        <button type="button" class="btn btn-info btn-edit"><a className='edit-btn' href='/viewQuizBody'>Go to Quizzes </a></button>
